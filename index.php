                    ...
                    <div class="container portfolio-slide-inner">
                        <div class="portfolio-browser">
                            <div class="portfolio-browser-bar">
                                ...
                                <div class="browser-url">www.shopifystore.nl</div>
                            </div>
                            <div class="portfolio-browser-screen screen-1">
                                <iframe id="ytPlayer1" src="https://www.youtube.com/embed/ndXO9zMCQbg?rel=0&modestbranding=1&autoplay=1&mute=1&enablejsapi=1" frameborder="0" allow="encrypted-media; picture-in-picture" allowfullscreen style="width:100%;height:100%;display:block;"></iframe>
                                <div class="yt-controls">
                                    <button class="yt-pause-btn" data-player="1" aria-label="Play/Pause">&#9646;&#9646;</button>
                                    <button class="yt-speed-btn" data-player="1">1x</button>
                                </div>
                            </div>
                        </div>
                        <div class="portfolio-slide-info">
                            <span class="portfolio-slide-num">01 / 04</span>
                            <span class="portfolio-category">E-COMMERCE</span>
                            <h3 class="portfolio-project-name">Shopify E-Commerce Store</h3>
                            <p class="portfolio-project-desc">Full e-commerce website with Shopify integration, fluid animations, a complete checkout system, and high-converting product pages built to maximise sales.</p>
                    ...
                    <div class="container portfolio-slide-inner">
                        <div class="portfolio-browser">
                            <div class="portfolio-browser-bar">
                                ...
                                <span class="browser-dot dot-yellow"></span>
                                <span class="browser-dot dot-green"></span>
                                <div class="browser-url">www.luxurybrand.nl</div>
                            </div>
                            <div class="portfolio-browser-screen screen-2">
                                <iframe id="ytPlayer2" src="https://www.youtube.com/embed/JQ30udq3tx4?rel=0&modestbranding=1&autoplay=1&mute=1&enablejsapi=1" frameborder="0" allow="encrypted-media; picture-in-picture" allowfullscreen style="width:100%;height:100%;display:block;"></iframe>
                                <div class="yt-controls">
                                    <button class="yt-pause-btn" data-player="2" aria-label="Play/Pause">&#9646;&#9646;</button>
                                    <button class="yt-speed-btn" data-player="2">1x</button>
                                </div>
                            </div>
                        </div>
                        <div class="portfolio-slide-info">
                            <span class="portfolio-slide-num">02 / 04</span>
                            <span class="portfolio-category">LUXURY</span>
                            <h3 class="portfolio-project-name">Luxury Brand — Concept Mockup</h3>
                            <p class="portfolio-project-desc">Mockup concept for businesses that want their website to convey premium, luxury, and beauty — unique features and animations that make every visitor feel the high-end experience.</p>
                            <div class="portfolio-slide-tags">
                    ...
                    <div class="container portfolio-slide-inner">
                        <div class="portfolio-browser">
                            <div class="portfolio-browser-bar">
                                ...
                                <span class="browser-dot dot-yellow"></span>
                                <span class="browser-dot dot-green"></span>
                                <div class="browser-url">www.clinicwebsite.nl</div>
                            </div>
                            <div class="portfolio-browser-screen screen-3">
                                <iframe id="ytPlayer3" src="https://www.youtube.com/embed/PCZLLTLcA7E?rel=0&modestbranding=1&autoplay=1&mute=1&enablejsapi=1" frameborder="0" allow="encrypted-media; picture-in-picture" allowfullscreen style="width:100%;height:100%;display:block;"></iframe>
                                <div class="yt-controls">
                                    <button class="yt-pause-btn" data-player="3" aria-label="Play/Pause">&#9646;&#9646;</button>
                                    <button class="yt-speed-btn" data-player="3">1x</button>
                                </div>
                            </div>
                        </div>
                        <div class="portfolio-slide-info">
                            <span class="portfolio-slide-num">03 / 04</span>
                            <span class="portfolio-category">CLINIC</span>
                            <h3 class="portfolio-project-name">Clinic Website</h3>
                            <p class="portfolio-project-desc">Clean and simple clinic website with smooth animations and a compelling video background — designed to build trust and convert visitors into bookings.</p>
                            <div class="portfolio-slide-tags">
                    ...
                    <div class="container portfolio-slide-inner">
                        <div class="portfolio-browser">
                            <div class="portfolio-browser-bar">
                                ...
                                <span class="browser-dot dot-yellow"></span>
                                <span class="browser-dot dot-green"></span>
                                <div class="browser-url">www.itprojectmanager.nl</div>
                            </div>
                            <div class="portfolio-browser-screen screen-4">
                                <iframe id="ytPlayer4" src="https://www.youtube.com/embed/VZZSlEOfipo?rel=0&modestbranding=1&autoplay=1&mute=1&enablejsapi=1" frameborder="0" allow="encrypted-media; picture-in-picture" allowfullscreen style="width:100%;height:100%;display:block;"></iframe>
                                <div class="yt-controls">
                                    <button class="yt-pause-btn" data-player="4" aria-label="Play/Pause">&#9646;&#9646;</button>
                                    <button class="yt-speed-btn" data-player="4">1x</button>
                                </div>
                            </div>
                        </div>
                        <div class="portfolio-slide-info">
                            <span class="portfolio-slide-num">04 / 04</span>
                            <span class="portfolio-category">IT PROJECT MANAGEMENT</span>
                            <h3 class="portfolio-project-name">Portfolio — IT Project Manager</h3>
                            <p class="portfolio-project-desc">Landing page for an IT project manager with 30 years of experience — designed to establish authority and make it easy for businesses to reach out for their next project.</p>
                            <div class="portfolio-slide-tags">
                                <span>Portfolio</span>
